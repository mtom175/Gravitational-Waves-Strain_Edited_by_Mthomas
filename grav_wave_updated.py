...
ax1.scatter(stars_x, stars_y, s=2, color='white')

# Black holes
bh1, = ax1.plot([],[],'o',color = 'white',markersize=30)
bh2, = ax1.plot([],[],'o',color = 'orange',markersize=30)


# Trails
trail1, = ax1.plot([],[],'white',lw=1)
trail2, = ax1.plot( [], [], 'orange',lw=1)
